...
export const metadata = {
    title: "Политика конфиденциальности | Любовь",
                        ...
                        <section className="space-y-6">
                            <div>
                                ...
                                <p className="text-sm leading-relaxed text-foreground/80">
                                    ...
                                    персональных данных пользователей сайта lubov-art.ru (далее — «Сайт»),
                                    принадлежащего ИП Любовь (далее — «Оператор»).
                                </p>
                            </div>

                            <div>
                                <h2 className="text-xl font-display italic mb-4">2. Сбор персональных данных</h2>
                            ...
                            <div>
                                <h2 className="text-xl font-display italic mb-4">3. Цели обработки данных</h2>
                                <p className="text-sm leading-relaxed text-foreground/80 mb-4">
                            ...
                            <div>
                                <h2 className="text-xl font-display italic mb-4">4. Защита данных</h2>
                                <p className="text-sm leading-relaxed text-foreground/80">
                            ...
                            <div>
                                <h2 className="text-xl font-display italic mb-4">5. Права пользователя</h2>
                                <p className="text-sm leading-relaxed text-foreground/80 mb-4">
                            ...
                            <div>
                                <h2 className="text-xl font-display italic mb-4">6. Контактная информация</h2>
                                <p className="text-sm leading-relaxed text-foreground/80">
                                    По всем вопросам, связанным с обработкой персональных данных, вы можете
                                    обратиться по адресу: <a href="mailto:info@lubov-art.ru" className="text-accent hover:underline">info@lubov-art.ru</a>
                                </p>
                            </div>
                        </section>
                    </article>
