...
export const metadata: Metadata = buildPageMetadata({
  title: "Реквизиты",
  description:
    "Актуальные юридические и банковские реквизиты галереи Любовь для договоров, безналичной оплаты, выставления счетов и официального документооборота.",
  path: "/legal-details",
  image: "/images/love_interior_emotion.webp",
  keywords: ["реквизиты", "юридическая информация"],
});
          ...
          <article className="max-w-3xl mx-auto">
            ...
            <div className="mt-16 p-6 bg-muted/30 rounded-lg">
              <p className="text-xs text-muted-foreground">
                Для получения счёта на оплату или заключения договора свяжитесь
                с нами по телефону или электронной почте. Мы подготовим все
