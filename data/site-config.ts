...
import type { NavigationItem, ContactInfo, SocialLink, FooterColumn } from '@/types';
...
export const siteConfig = {
    ...
    /** SEO description */
    description: 'Создаём уникальные интерьерные решения, воплощая ваши идеи в жизнь.',
...
export const socialLinks: SocialLink[] = [
    { name: 'Instagram*', href: contactConfig.instagram, label: 'Мы в Instagram' },
    { name: 'Telegram', href: contactConfig.telegram, label: 'Мы в Telegram' },
    { name: 'WhatsApp', href: contactConfig.whatsapp, label: 'Написать в WhatsApp' },
];
...
export const footerConfig: FooterColumn[] = [
    {
        ...
        links: [
            ...
            { label: contactConfig.phone, href: `tel:${contactConfig.phone.replace(/\\s/g, '')}` },
        ],
    },
    {
        title: 'Помощь',
