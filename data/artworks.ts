...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    images: [
      "/images/eredita-1.webp",
      "/images/eredita-2.webp",
      "/images/eredita-3.webp",
      "/images/eredita-4.webp",
    ],
    aspectRatio: "landscape",
    tags: ["Классика", "Премиум"],
    description:
      "Eredita, вдохновлённая привычками своих хозяев, напоминает классическую диванетку, достойную пунктуального щенка, который всегда первым выбегает за дверь, чтобы отправиться на прогулку. Дизайн модели отличается чёткими линиями, которые привлекают внимание. Каждая деталь покрыта высококачественным лаком, который защищает натуральный шпон и подчёркивает его текстуру. В сочетании с водоотталкивающей подушкой со съёмным моющимся чехлом Eredita станет местом, где даже самые серьезные собаки смогут расслабиться.",
    options: {
  ...
  },
  {
    ...
    tags: ["Услуга", "Премиум"],
    description:
      "Профессиональная перетяжка мебели с использованием эксклюзивных тканей из нашей коллекции.",
  },
  {
    id: "ts2",
    category: "textile",
    ...
    tags: ["Услуга", "Декор"],
    description:
      "Индивидуальный пошив подушек любых форм и размеров из премиального текстиля.",
  },
  {
    id: "ts3",
    category: "textile",
    ...
    description:
      "Создание уникальных текстильных решений для ваших окон. Подбор тканей и профессиональный пошив.",
  },
  {
    id: "coll-shantaram",
    ...
    tags: ["САНГИТА", "ШИНАМ"],
    description:
      "В коллекцию входят панно САНГИТА и ковер ШИНАМ. Идеальное сочетание для вашего интерьера.",
    isNew: true,
  },
  {
    id: "coll-nachalo",
    ...
    tags: ["UNIvers", "Уно"],
    description:
      "В коллекцию входят панно UNIvers и ковер Уно. Эстетика минимализма для вашего пространства.",
  },
  {
    id: "coll-3",
    category: "collections",
...
export const categoryThemes: Record<
  string,
  {
    ...
    subtitle: string;
    accentColor: string;
    subnav: (string | { label: string; href: string })[];
  }
> = {
  painting: {
    title: "Живопись",
