    ...
    <nav className="hidden xl:flex items-center justify-center gap-10 mx-4">
        {navigationConfig.map((item) => {
            if (item.name === 'Каталог') {
                return (
                    <div key={item.name} className="relative group/catalog flex items-center">
                        <NavLink href={item.href}>
                            <>
                                {item.name}
                                <ChevronDown size={11} className="text-muted-foreground/60 group-hover/catalog:rotate-180 transition-transform duration-500" />
                            </>
                        </NavLink>
                        ...
                        return (
                            <div key={item.name} className="flex flex-col items-center gap-4 w-full">
                                ...
                                >
                                    ...
                                    <ChevronDown size={14} className={cn("transition-transform duration-300", isCatalogOpen && "rotate-180")} />
                                </button>
