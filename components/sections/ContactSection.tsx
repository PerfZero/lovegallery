...
import { DSHeading, DSLabel, DSDecorativeAsterisk, DSText } from "@/components/ui/design-system";
...
const ContactSection = ({ opacity }: ContactSectionProps) => {
    ...
    return (
        ...
        >
            <section className="flex-grow flex flex-col justify-end items-center text-center px-6 min-h-[40vh] bg-background/80 backdrop-blur-md p-10">
                <div className="max-w-4xl mx-auto space-y-12 md:space-y-16">
                    ...
                    {/* Headline */}
                    <DSHeading level="h2" className="text-3xl md:text-5xl lg:text-6xl leading-tight">
                        {headline.line1}
                        <br />
                        <span className="text-foreground/60 opacity-80">{headline.line2}</span>
                    </DSHeading>
                    ...
                    <div className="pt-8 space-y-6">
                        ...
                        <div className="flex justify-center gap-12 pt-8">
                            <DSLabel as="a" href={contactConfig.instagram} className="hover:text-accent transition-colors">Instagram</DSLabel>
                            <DSLabel as="a" href={contactConfig.telegram} className="hover:text-accent transition-colors">Telegram</DSLabel>
                        </div>
                    </div>
                </div>
            </section>
